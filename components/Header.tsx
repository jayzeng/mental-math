...
const Header: React.FC<HeaderProps> = ({ level, progressCount, progressTotal, onGoHome, onViewCollection }) => {
  return (
    <div className="flex justify-between items-center mb-12 bg-white p-5 rounded-[32px] shadow-xl border-b-8 border-blue-200">
      ...
      <div className="flex items-center gap-4">
        ...
        >
          ...
          <span className="text-2xl font-black text-pink-900">{progressCount}/{progressTotal}</span>
        </button>
      </div>
    </div>
  );
